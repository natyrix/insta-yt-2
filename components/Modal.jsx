...
export default function Modal() {
    ...
    const uploadPost = async ()=>{
        ...
        console.log("NEW DOC ADDEDD WITH ID ", docRef.id)
    ...
    <Transition.Root show={open} as={Fragment}>
        <Dialog as='div' className='fixed z-10 inset-0 overflow-y-auto' onClose={setOpen}>
            <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <span className='hidden sm:inline-block sm:align-middle sm:h-screen'>&#8203</span>
                ...
                <Transition.Child
                    ...
                    leaveTo='opacity-0 translate-y-4 sm:translte-y-0 sm:scale-95'
                    >
                            ...
                            <div className="">
                                {selectedFile?(
                                    <img
                                        ...
                                        src={selectedFile} onClick={()=> setSelectedFile(null)}/>
                                ):(<div
